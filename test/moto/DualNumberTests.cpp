...
TEST(DualNumber, AutomaticDifferentiation)
{
...
TEST(DualNumber, PlueckerCoordinates)
{
...
TEST(DualNumber, VelocityIntegration)
{
...
TEST(DualNumber, DualQuaternionLogarithm)
{
    Scalar theta = 1;
    for (int k = 0; k != 12; ++k)
    {
