...
#pragma once
#ifndef _MSVC90STDVECTORFIX_HPP
#define _MSVC90STDVECTORFIX_HPP
#ifndef RC_INVOKED
#include <memory>
#include <stdexcept>
...
public:
 ...
 #else
	explicit _Vectorfix_const_iterator(_Tptr _Ptr)
		{	// construct with pointer _Ptr
		_Myptr = _Ptr;
		}
...
public:
 ...
 #else
 	explicit _Vectorfix_iterator(pointer _Ptr)
		: _Mybase(_Ptr)
		{	// construct with pointer _Ptr
		}
 #endif /* _HAS_ITERATOR_DEBUGGING */
...
public:
 ...
 #if _HAS_ITERATOR_DEBUGGING
	_Vfixb_iter_base(_Vbase *_Ptr, _Sizet _Off,
...
template<class _Sizet,
	...
	class _MycontTy>
	class _Vfixb_reference
		: public _Vfixb_iter_base<_Sizet, _Difft, _MycontTy>
	{	// reference to a bit within a base word
public:
	typedef _Vfixb_iter_base<_Sizet, _Difft, _MycontTy> _Mybase;
	typedef _Vfixb_reference<_Sizet, _Difft, _MycontTy> _Mytype;
 ...
 #if _HAS_ITERATOR_DEBUGGING || _SECURE_SCL
	_Vfixb_reference(const _Mybase& _Right)
...
template<class _Sizet,
	class _Difft,
	class _MycontTy>
	void swap(_Vfixb_reference<_Sizet, _Difft, _MycontTy> _Left,
		_Vfixb_reference<_Sizet, _Difft, _MycontTy> _Right)
...
public:
	typedef _Vfixb_iter_base<_Sizet, _Difft, _MycontTy> _Mybase;
	typedef _Vfixb_const_iterator<_Sizet, _Difft, _MycontTy> _Mytype;

	typedef _Vfixb_reference<_Sizet, _Difft, _MycontTy> _Reft;
 ...
 #if _HAS_ITERATOR_DEBUGGING || _SECURE_SCL
	_Vfixb_const_iterator(const _Vbase *_Ptr, const _Container_base *_Mypvbool)
...
template<class _Sizet,
	class _Difft,
	class _MycontTy>
	_Vfixb_const_iterator<_Sizet, _Difft, _MycontTy> operator+(_Difft _Off,
		_Vfixb_const_iterator<_Sizet, _Difft, _MycontTy> _Right)
...
template<class _Sizet,
	...
	class _MycontTy>
	class _Vfixb_iterator
		: public _Vfixb_const_iterator<_Sizet, _Difft, _MycontTy>
	{	// iterator for mutable vectorfix<bool>
public:
	typedef _Vfixb_const_iterator<_Sizet, _Difft, _MycontTy> _Mybase;
	typedef _Vfixb_iterator<_Sizet, _Difft, _MycontTy> _Mytype;
 ...
 #if _HAS_ITERATOR_DEBUGGING || _SECURE_SCL
	_Vfixb_iterator(_Vbase *_Ptr, _Container_base *_Mypvbool)
...
template<class _Sizet,
	class _Difft,
	class _MycontTy>
	_Vfixb_iterator<_Sizet, _Difft, _MycontTy> operator+(_Difft _Off,
		_Vfixb_iterator<_Sizet, _Difft, _MycontTy> _Right)
		{	// return _Right + integer
		return (_Right += _Off);
		}
...
public:
	...
	typedef _Vfixb_reference<size_type, _Dift, _Myt> reference;
	typedef bool const_reference;
	typedef bool value_type;

	typedef reference _Reft;
	typedef _Vfixb_const_iterator<size_type, difference_type, _Myt> const_iterator;
	typedef _Vfixb_iterator<size_type, difference_type, _Myt> iterator;

	friend class _Vfixb_iter_base<size_type, difference_type, _Myt>;
	friend class _Vfixb_reference<size_type, difference_type, _Myt>;
	friend class _Vfixb_const_iterator<size_type, difference_type, _Myt>;
	friend class _Vfixb_iterator<size_type, difference_type, _Myt>;
	...
	static const int _VFIXBITS = std::_VFIXBITS;
...
protected:
	...
	void _Orphan_range(size_type _Offlo, size_type _Offhi) const
		{	// orphan iterators within specified (inclusive) range
		typedef _Vfixb_iter_base<size_type, difference_type, _Myt> _Myiterbase;
...
typedef vectorfix<bool, allocator<bool> > _Bvectorfix;
 ...
 typedef _Bvectorfix bit_vectorfix;
 #define __vectorfix__	vectorfix
